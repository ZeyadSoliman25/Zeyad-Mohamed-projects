...
public:	
	...
	void SetStatCount(int);					//Sets the number of statements	during loading of flowcharts
	
	void GetStatDeleted(int);				//update the statlist with the deleted statement
	...
	void SaveAll(ofstream& OutFile);								//Save all the statements and connectors 
	void LoadAll(ifstream& Infile);								//Load all the statements and connectors
